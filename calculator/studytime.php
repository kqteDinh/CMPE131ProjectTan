...
<p class="font-weight-bold text-center"> Can't choose what to listen to for hw?</p>
<figure class="text-center">
  <img src="images/ghibli.png" class="figure-img img-fluid rounded" alt="self placeholder">
  <figcaption class="figure-caption"> </figcaption>

<a href="https://open.spotify.com/playlist/5jri6obxOBOiQb8kjz6ApS?si=049d29ab1b304e6f" class="btn btn-success" role="Studio Ghibli playlist">Studio Ghibli Pomodoro!</a>
<figure class="text-center">
  <img src="images/coffee.png" class="figure-img img-fluid rounded" alt="self placeholder">
  <figcaption class="figure-caption"> </figcaption>

<a href="https://open.spotify.com/playlist/1u8VsYfaSXuVKRXMyJSs0F?si=b028be476c724071" class="btn btn-success" role="Coffee Shop playlist">Coffee Shop Pomodoro!</a>
