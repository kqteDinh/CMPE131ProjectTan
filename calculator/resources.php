...
<p class="font-weight-bold text-center h4">Techniques for Effective Studying</p>
<p class="font-weight-bold text-center">The Pomodoro Technique: </p>
<p class="font-weight-normal text-center">Step 1: Focus on 1 task only</p>
<p class="font-weight-normal text-center">Step 2: Set a 25 min timer(or use the playlists provided) where you only work on the task</p>
<p class="font-weight-normal text-center">Step 3: Once the 25 minutes are over, take a 5 minute break</p>
<p class="font-weight-normal text-center">Step 4: Every 4 cycles, take a 15-20 min break</p>

<p class="font-weight-bold text-center h4">  </p>
<p class="font-weight-bold text-center">Why this Technique Works: </p>
<p class="font-weight-normal text-center">Short intervals of studying and breaks helps to increase focus</p>
<p class="font-weight-normal text-center">Having something change in your environment to signal that your studying is over is more effective than a silent alarm </p>
