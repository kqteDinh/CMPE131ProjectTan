...
<p class="font-weight-bold">  </p>
<p class="font-weight-bold text-center">The Problem:</p>
<figure class="text-center">
  <img src="images/statistics.jpg" class="figure-img img-fluid rounded" alt="statistic figure placeholder">
  <figcaption class="figure-caption">Results from 2014 Student Psyche Report</figcaption>
</figure>
<p class="text-center">- 85% of students say that the pandemic has had a negative effect on their college performance</p>
<p class="text-center">  - The pandemic has not only affected educational performance, but also mental health</p>
<p class="text-center">  - 38% of students surveyed said that focusing on work/studies was their main source of stress</p>
<!-- Footer -->
